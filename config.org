          ...
          (let* ((key (car l))
                 (def
                  (cond ((string-match "^[[:alnum:]]\\{2\\}$" (format "%s" key))
                        ...
                        ((string-match "^<Leader>[[:alnum:]]*$" (format "%s" key))
                         (format "evil-leader/set-key \"%s\"" (cadr (split-string key "<Leader>"))))
...
| <Leader>h        | Evil        | Split window horizontally                                 | 'split-window-horizontally                                  |
| <Leader>v        | Evil        | Split window vertically                                   | 'split-window-verticall                                     |
